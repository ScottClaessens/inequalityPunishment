...
class Player(BasePlayer):
    ...
    employment = models.IntegerField(label="Are you currently employed?", choices=[[0, 'No'], [1, 'Yes']], widget=widgets.RadioSelect)
    married = models.IntegerField(label="Are you currently married?", choices=[[0, 'No'], [1, 'Yes']], widget=widgets.RadioSelect)
    education = models.StringField(label="What is your highest achieved level of education?")
    income = models.StringField(label="Please estimate your annual household income.")
